...
const ownerNumber = ['255693629079']
...
console.log("𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙸𝙽𝙶 𝙷𝙴𝚁𝙾𝙺𝚄 𝚇𝙼𝙳 💫...");
...
console.log('𝙷𝙴𝚁𝙾𝙺𝚄 𝚇𝙼𝙳 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 𝚃𝙾 𝚆𝙷𝙰𝚃𝚂𝙰𝙿𝙿 𝙴𝙽𝙹𝙾𝚈 ✅')

let up = ` ʙᴏᴛ⇨⇨ Connected Successfully!!!!!!* ✅ 

 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ 𝙷𝙴𝚁𝙾𝙺𝚄 𝚇𝙼𝙳

*🔹 ᴘʀᴇғɪx:* *${prefix}*

*🔹 ᴏᴡɴᴇʀ:* 255693629079

*🌟 Join My WhatsApp Channels✓🌟* 
...
> *ᴘᴏᴡᴇʀᴇᴅ ʙʏ 𝙷𝙴𝚁𝙾𝙺𝚄 𝚇𝙼𝙳 𝙱𝙾𝚃 ✅*`;
conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/aax81i.jpg` }, caption: up })
...
//================ownerreact
if(senderNumber.includes("255693629079")){
if(isReact) return
m.react("👑")
}
...
app.get("/", (req, res) => {
res.send("𝙷𝙴𝚁𝙾𝙺𝚄 𝚇𝙼𝙳 is 𝙲𝙾𝙽𝙽𝙴𝙲𝚃𝙴𝙳 ✅");
});
